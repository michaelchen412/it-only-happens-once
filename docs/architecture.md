...
4. **Constellations & placement** — create lenses, place fragments, order the suite (`position`). Deferred to ship *with the Sky*, where that UI belongs; the on-ramp toward the "synthesis instrument" in `vision.md`.
