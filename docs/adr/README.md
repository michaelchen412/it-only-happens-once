...
| [0021](0021-dark-is-the-default-not-the-system-preference.md) | Dark is the site's own default and light is an opt-in; `prefers-color-scheme` is not consulted, and the status bar follows the choice | **Proposed** |
