...
| **Song quick-editor** | slide-over, any admin page | Light: paste a Spotify track or album link → title/art/embed auto-fill; artist/album/year, subjects, and **"Why this one"** — the annotation that leads the public stanza (§6). **Publishes on save** (like quotes); unpublish via the list. |
