...
| **Facts** | Title, artist, album, the added year, **Shared by**, and the **pieces this song is paired to** — the most useful fact about 46 of the 48. A list with a per-row **Unpair** and a **＋ Pair with a piece** door onto the picker (§6c). |
