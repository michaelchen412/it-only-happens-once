...
export default defineConfig({
  ...
  integrations: [
    icon({
      include: {
        ph: ['clock-light', 'magnifying-glass', 'x', 'caret-down', 'caret-left', 'caret-right', 'arrow-right', 'arrow-up', 'arrow-up-right', 'funnel', 'trash', 'plus', 'sun', 'moon', 'list', 'stack', 'books', 'user-circle', 'image'],
